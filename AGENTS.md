...
When the user asks to merge a PR, use squash merge by default. Do not use a
...
- Keep GitHub's autogenerated commit-message list in the squash body by
  default. Add any needed summary, verification notes, issue-closing
  references, or release-relevant notes without deleting the autogenerated
  commit-message list.
- If the correct squash title or body is unclear, stop and ask before merging.
